...
<script setup>
	...
	import useCustomerDevices from '@/modules/invoices/composables/customer_devices';
	...
	onMounted(async () => {
		...
		formData.cost_price = customerDevice.value.cost_price;
		formData.sale_price = customerDevice.value.sale_price;
		formData.installation_price = customerDevice.value.installation_price;
		formData.started_at = customerDevice.value.started_at;
		formData.finished_at = customerDevice.value.finished_at;
	});
