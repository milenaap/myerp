...
<script setup>
	...
	onMounted(async () => {
		...
		formData.car = customerDevice.value.car;
		formData.device = customerDevice.value.device;
		formData.device_id = customerDevice.value.device_id;
		formData.sim = customerDevice.value.sim;
		formData.installed_at = customerDevice.value.installed_at;
		formData.subscription_price = customerDevice.value.subscription_price;
		formData.payable_days = customerDevice.value.payable_days;
